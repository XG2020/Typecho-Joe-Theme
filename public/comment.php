            ...
            <div class="item">
                ...
                <div class="right">
                    <div class="name">
                        ...
                        <?php dengji1($comments->mail);?>
                        <?php if ($comments->status === "waiting") : ?>
                            <em>（审核后可见）</em>
                        <?php endif; ?>
                        <div><?php GetOs($comments->agent); ?> · <?php GetBrowser($comments->agent); ?> <?php if (Helper::options()->JCommentIp === 'on') : ?>· <?php convertip($comments->ip); ?><?php endif; ?></div>
                    </div>
...
<div id="comments" class="j-comment" data-respondId="<?php $this->respondId() ?>">
    ...
    <?php if ($this->allow('comment') && $this->options->JCommentStatus !== "off") : ?>
        <div id="<?php $this->respondId(); ?>" class="respond">
            <div class="change" id="commentType">
                 <?php if ($this->options->huaban === 'on') : ?><button data-type="canvas">画图模式</button><?php endif; ?>
    ...
    <?php else : ?>
        <div style="text-align: center;">
                <svg class="close-icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" width="18" height="18">
                ...
                <?php if ($this->options->JCommentStatus === "off") : ?>
                    <span class="close">所有评论功能已关闭</span>
                <?php else : ?>
                    <span class="close">本篇文章评论功能已关闭</span>
                <?php endif; ?>
        </div>
    <?php endif; ?>
</div>