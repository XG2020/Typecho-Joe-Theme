	...
	<?php /* 登录了 */ if ($this->user->hasLogin()): ?>
        <div class="aside aside-user">
            <div class="user">
                ...
                <a href="<?php echo getUserPermalink($this->user->uid); ?>"><?php $this->user->screenName(); ?><?php dengji($this->user->uid);?></a>
				<!--访问量-->				
        ...
        <div class="aside aside-user">
            <div class="user">
                ...
                <a href="<?php echo getUserPermalink($this->author->uid); ?>"><?php $this->author->screenName(); ?><?php dengji($this->author->uid);?></a>                
				<!--访问量-->				
