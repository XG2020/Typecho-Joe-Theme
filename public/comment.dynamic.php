...
?>
    <li id="li-<?php $comments->theId(); ?>">
        <div class="comment-parent">
            ...
            <div class="foot">
            <div class="count"><?php GetOs($comments->agent); ?> · <?php GetBrowser($comments->agent); ?> <?php if (Helper::options()->JDynamicCommentIp === 'on') : ?>· <?php convertip($comments->ip); ?><?php endif; ?></div>
                <div class="action">
