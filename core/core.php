        ...
        <script>
            $(function() {
                ...
                $("#wmd-button-row #wmd-fullscreen-button").before(`
                    ...
                    <li class="wmd-button custom" id="j-wmd-video-plyr" title="插入视频（dplayer弹幕）">
                        <svg t="1608784905877" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2440" width="128" height="128"><path d="M770.688 915.456c-1.152 0-2.176-0.128-3.328-0.256l-535.68-69.76c-50.432-5.632-90.24-51.968-90.24-105.216V379.008c0-53.376 39.808-99.584 90.752-105.344l535.296-69.888c1.152-0.128 2.176-0.256 3.328-0.256 61.696 0 111.872 53.888 111.872 119.936v471.936c-0.128 66.304-50.304 120.064-112 120.064z m1.536-660.608L238.336 324.48c-25.344 2.816-45.696 27.264-45.696 54.528v361.088c0 27.264 20.352 51.584 45.312 54.4l534.4 69.76c32.768-0.896 59.136-31.36 59.136-68.736V323.584c-0.128-37.376-26.496-67.84-59.264-68.736z" p-id="2441" fill="#888888"></path><path d="M634.752 528.768l-143.872-92.8c-23.68-13.696-53.376 3.456-53.376 30.848v185.6c0 27.392 29.696 44.544 53.376 30.848l143.872-92.8c23.68-13.824 23.68-48 0-61.696z" p-id="2442" fill="#888888"></path></svg>
                    </li>
                    ...
                    <li class="wmd-button custom" id="j-wmd-video-MP3" title="MP3">
                        <svg class="icon" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 width="27.684px" height="27.683px" viewBox="0 0 27.684 27.683" style="enable-background:new 0 0 27.684 27.683;"
	 xml:space="preserve"><g><path d="M7.976,2.536v14.531c-0.767-0.336-1.639-0.548-2.58-0.548C2.415,16.519,0,18.452,0,20.835c0,2.383,2.415,4.313,5.396,4.313
		...
		h14.074V7.462z"/></g></svg>
                ...
                $("#j-wmd-video-plyr").on("click", function() {
