<section class="tags">
    ...
    <section class="handle">
        <section class="item" id="read" title="朗读文章">
            ...
            <span onclick="if(!document.getElementById('audio_read').paused ){document.getElementById('audio_read').pause();}else{allstop();document.getElementById('audio_read').play();}">朗读</span>
...
<audio id='audio_read' name='audios[]' src='https://tts.baidu.com/text2audio?lan=zh&ie=UTF-8&spd=5&text=<?php $this->content('Continue Reading...'); ?>' controls='controls' hidden></audio>